...
// `index_not_found_exception`) when the item failed with an error block.
// Empty on 2xx success and on delete-404 responses (delete of a missing doc
// sets `result:"not_found"` without an error block).
