...
echo "=== Ready! ==="
echo ""
echo "  # Start the shared NATS (creates the chat-local network)"
echo "  docker compose -f docker-local/compose.nats.yaml up -d"
echo ""
echo "  # Start any microservice — it joins chat-local automatically"
echo "  docker compose -f broadcast-worker/deploy/docker-compose.yml up -d"
echo ""
echo "  ──────────────────────────────────────"
