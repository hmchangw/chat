...
// Source: github.com/hmchangw/chat/user-service/service (interfaces: SubscriptionRepository,UserRepository,AppRepository,RoomClient,EventPublisher,RoomKeyReader)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_repository.go -package=mocks . SubscriptionRepository,UserRepository,AppRepository,RoomClient,EventPublisher,RoomKeyReader
//
...
// MockRoomKeyReader is a mock of RoomKeyReader interface.
type MockRoomKeyReader struct {
	ctrl     *gomock.Controller
	recorder *MockRoomKeyReaderMockRecorder
	isgomock struct{}
}

// MockRoomKeyReaderMockRecorder is the mock recorder for MockRoomKeyReader.
type MockRoomKeyReaderMockRecorder struct {
	mock *MockRoomKeyReader
}

// NewMockRoomKeyReader creates a new mock instance.
func NewMockRoomKeyReader(ctrl *gomock.Controller) *MockRoomKeyReader {
	mock := &MockRoomKeyReader{ctrl: ctrl}
	mock.recorder = &MockRoomKeyReaderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRoomKeyReader) EXPECT() *MockRoomKeyReaderMockRecorder {
	return m.recorder
}

// GetMany mocks base method.
func (m *MockRoomKeyReader) GetMany(ctx context.Context, roomIDs []string) (map[string]*roomkeystore.VersionedKeyPair, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRoomKeyReaderMockRecorder) GetMany(ctx, roomIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMany", reflect.TypeOf((*MockRoomKeyReader)(nil).GetMany), ctx, roomIDs)
}
