...
// Source: github.com/hmchangw/chat/history-service/internal/service (interfaces: MessageReader,MessageWriter,MessageRepository,SubscriptionRepository,EventPublisher,ThreadRoomRepository,RoomKeyProvider,RoomTimeResolver)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_repository.go -package=mocks . MessageReader,MessageWriter,MessageRepository,SubscriptionRepository,EventPublisher,ThreadRoomRepository,RoomKeyProvider,RoomTimeResolver
//
...
func (m *MockMessageReader) GetMessagesAfter(ctx context.Context, roomID string, after time.Time, ceiling time.Time, pageReq cassrepo.PageRequest) (cassrepo.Page[models.Message], error) {
	m.ctrl.T.Helper()
...
func (m *MockMessageReader) GetMessagesBefore(ctx context.Context, roomID string, before time.Time, floor time.Time, pageReq cassrepo.PageRequest) (cassrepo.Page[models.Message], error) {
	m.ctrl.T.Helper()
...
// GetMessagesAfter mocks base method.
func (m *MockMessageRepository) GetMessagesAfter(ctx context.Context, roomID string, after time.Time, ceiling time.Time, pageReq cassrepo.PageRequest) (cassrepo.Page[models.Message], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMessagesAfter", ctx, roomID, after, ceiling, pageReq)
	ret0, _ := ret[0].(cassrepo.Page[models.Message])
	ret1, _ := ret[1].(error)
...
// GetMessagesBefore mocks base method.
func (m *MockMessageRepository) GetMessagesBefore(ctx context.Context, roomID string, before time.Time, floor time.Time, pageReq cassrepo.PageRequest) (cassrepo.Page[models.Message], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMessagesBefore", ctx, roomID, before, floor, pageReq)
	ret0, _ := ret[0].(cassrepo.Page[models.Message])
	ret1, _ := ret[1].(error)
...
// MockRoomTimeResolver is a mock of RoomTimeResolver interface.
type MockRoomTimeResolver struct {
	ctrl     *gomock.Controller
	recorder *MockRoomTimeResolverMockRecorder
	isgomock struct{}
}

// MockRoomTimeResolverMockRecorder is the mock recorder for MockRoomTimeResolver.
type MockRoomTimeResolverMockRecorder struct {
	mock *MockRoomTimeResolver
}

// NewMockRoomTimeResolver creates a new mock instance.
func NewMockRoomTimeResolver(ctrl *gomock.Controller) *MockRoomTimeResolver {
	mock := &MockRoomTimeResolver{ctrl: ctrl}
	mock.recorder = &MockRoomTimeResolverMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRoomTimeResolver) EXPECT() *MockRoomTimeResolverMockRecorder {
	return m.recorder
}

// GetRoomTimes mocks base method.
func (m *MockRoomTimeResolver) GetRoomTimes(ctx context.Context, roomID string) (time.Time, time.Time, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRoomTimeResolverMockRecorder) GetRoomTimes(ctx, roomID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoomTimes", reflect.TypeOf((*MockRoomTimeResolver)(nil).GetRoomTimes), ctx, roomID)
}
