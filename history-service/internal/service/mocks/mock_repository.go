...
// Source: github.com/hmchangw/chat/history-service/internal/service (interfaces: MessageReader,MessageWriter,MessageRepository,SubscriptionRepository,RoomRepository,EventPublisher,ThreadRoomRepository)
//
// Generated by this command:
//
//	mockgen -destination=history-service/internal/service/mocks/mock_repository.go -package=mocks github.com/hmchangw/chat/history-service/internal/service MessageReader,MessageWriter,MessageRepository,SubscriptionRepository,RoomRepository,EventPublisher,ThreadRoomRepository
//
...
// GetReactionsByMessageID mocks base method.
func (m *MockMessageReader) GetReactionsByMessageID(ctx context.Context, messageID string) (cassrepo.ReactionMap, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReactionsByMessageID", ctx, messageID)
	ret0, _ := ret[0].(cassrepo.ReactionMap)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetReactionsByMessageID indicates an expected call of GetReactionsByMessageID.
func (mr *MockMessageReaderMockRecorder) GetReactionsByMessageID(ctx, messageID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReactionsByMessageID", reflect.TypeOf((*MockMessageReader)(nil).GetReactionsByMessageID), ctx, messageID)
}

// GetReactionsByMessageIDs mocks base method.
func (m *MockMessageReader) GetReactionsByMessageIDs(ctx context.Context, messageIDs []string) (map[string]cassrepo.ReactionMap, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReactionsByMessageIDs", ctx, messageIDs)
	ret0, _ := ret[0].(map[string]cassrepo.ReactionMap)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetReactionsByMessageIDs indicates an expected call of GetReactionsByMessageIDs.
func (mr *MockMessageReaderMockRecorder) GetReactionsByMessageIDs(ctx, messageIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReactionsByMessageIDs", reflect.TypeOf((*MockMessageReader)(nil).GetReactionsByMessageIDs), ctx, messageIDs)
}
...
// GetReactionsByMessageID mocks base method.
func (m *MockMessageRepository) GetReactionsByMessageID(ctx context.Context, messageID string) (cassrepo.ReactionMap, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReactionsByMessageID", ctx, messageID)
	ret0, _ := ret[0].(cassrepo.ReactionMap)
	ret1, _ := ret[1].(error)
...
// GetReactionsByMessageID indicates an expected call of GetReactionsByMessageID.
func (mr *MockMessageRepositoryMockRecorder) GetReactionsByMessageID(ctx, messageID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReactionsByMessageID", reflect.TypeOf((*MockMessageRepository)(nil).GetReactionsByMessageID), ctx, messageID)
}

// GetReactionsByMessageIDs mocks base method.
func (m *MockMessageRepository) GetReactionsByMessageIDs(ctx context.Context, messageIDs []string) (map[string]cassrepo.ReactionMap, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReactionsByMessageIDs", ctx, messageIDs)
	ret0, _ := ret[0].(map[string]cassrepo.ReactionMap)
	ret1, _ := ret[1].(error)
...
// GetReactionsByMessageIDs indicates an expected call of GetReactionsByMessageIDs.
func (mr *MockMessageRepositoryMockRecorder) GetReactionsByMessageIDs(ctx, messageIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReactionsByMessageIDs", reflect.TypeOf((*MockMessageRepository)(nil).GetReactionsByMessageIDs), ctx, messageIDs)
}
