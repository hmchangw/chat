...
//
//	mockgen -destination=history-service/internal/service/mocks/mock_repository.go -package=mocks github.com/hmchangw/chat/history-service/internal/service MessageReader,MessageWriter,MessageRepository,SubscriptionRepository,RoomRepository,EventPublisher,ThreadRoomRepository,UserStore,CustomEmojiStore
//
...
func (m *MockMessageWriter) ToggleReaction(ctx context.Context, msg *models.Message, shortcode string, actor models.Participant, reactedAt time.Time) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ToggleReaction", ctx, msg, shortcode, actor, reactedAt)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMessageWriterMockRecorder) ToggleReaction(ctx, msg, shortcode, actor, reactedAt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ToggleReaction", reflect.TypeOf((*MockMessageWriter)(nil).ToggleReaction), ctx, msg, shortcode, actor, reactedAt)
}
...
// ToggleReaction mocks base method.
func (m *MockMessageRepository) ToggleReaction(ctx context.Context, msg *models.Message, shortcode string, actor models.Participant, reactedAt time.Time) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ToggleReaction", ctx, msg, shortcode, actor, reactedAt)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// ToggleReaction indicates an expected call of ToggleReaction.
func (mr *MockMessageRepositoryMockRecorder) ToggleReaction(ctx, msg, shortcode, actor, reactedAt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ToggleReaction", reflect.TypeOf((*MockMessageRepository)(nil).ToggleReaction), ctx, msg, shortcode, actor, reactedAt)
}
