...
// Checkpoint is the persisted resume position for one (site, collection). The
// ResumeToken is the real checkpoint (opaque, raw BSON so it round-trips
// exactly); ClusterTime is a coarse fallback + observability aid.
