...
vi.mock('./RoomMembersBadge', () => ({ default: () => null }))
vi.mock('./InRoomSearch', () => ({ default: () => null }))
vi.mock('./ManageMembersDialog', () => ({ default: () => null }))
...
vi.mock('../components/RoomMessageInput', () => ({ default: () => null }))
