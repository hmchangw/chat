...
//     and not executed.
//
// hugeParam: subCtx is copied intentionally — flow-level snapshot semantics.
//
//nolint:gocritic
...
// scenario).
// hugeParam: parent is copied by design — that's what snapshot means.
//
//nolint:gocritic
...
// hugeParam: src is a goroutine-local snapshot; copy is intentional.
//
//nolint:gocritic
