...
// newE2Handler must record the broadcast solely from the cleartext envelope's
// LastMsgID so that encrypted broadcasts (Message=nil) are not silently dropped.
