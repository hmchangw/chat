...
func (m *MockInboxStore) DeleteSubscriptionByID(ctx context.Context, id string) error {
	m.ctrl.T.Helper()
...
func (mr *MockInboxStoreMockRecorder) DeleteSubscriptionByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSubscriptionByID", reflect.TypeOf((*MockInboxStore)(nil).DeleteSubscriptionByID), ctx, id)
}
