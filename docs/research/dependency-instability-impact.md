...
**Licensing posture is healthy.** All four are on OSI-approved/permissive licenses today, and the Valkey fork
*de-risked* the earlier Redis SSPL problem. Licensing is not a near-term operational risk (details per dependency).
